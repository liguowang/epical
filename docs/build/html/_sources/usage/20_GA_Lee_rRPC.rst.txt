...
.. csv-table::
   ...
   "Alias", "refined robust placental clock, rRPC"

Usage
-----
.. code-block:: text

 usage: epical GA_Lee_rRPC [-h] [-o out_prefix] [-p PERCENT] [-d DELIMITER]
...
``$ epical GA_Lee_rRPC Test6_Placentas_N40_450K_beta.tsv.gz -m Test6_Placentas_N40_450K_info.tsv -o GA_Lee_rRPC``
