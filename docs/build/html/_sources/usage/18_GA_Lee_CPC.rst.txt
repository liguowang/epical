...
.. csv-table::
   ...
   "Alias", "A control placental clock (CPC)"

Usage
-----
.. code-block:: text

 usage: epical GA_Lee_CPC [-h] [-o out_prefix] [-p PERCENT] [-d DELIMITER]
...
``$ epical GA_Lee_CPC Test6_Placentas_N40_450K_beta.tsv.gz -m Test6_Placentas_N40_450K_info.tsv -o GA_Lee_CPC``

.. code-block:: text

 2024-01-23 12:07:03 [INFO]  The prefix of output files is set to "GA_Lee_CPC".
 2024-01-23 12:07:03 [INFO]  Loading GA_Lee_CPC clock data ...
 2024-01-23 12:07:03 [INFO]  Clock's name: "Lee_gestational_CPC"
